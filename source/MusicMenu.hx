...
class MusicMenu extends MusicBeatState
{
	...
	override function create()
	{
		...
		tapeJads.antialiasing = !FlxG.save.data.lowend;
		tapeRaze.antialiasing = !FlxG.save.data.lowend;
		tapeYing.antialiasing = !FlxG.save.data.lowend;
		...
		circleOne.antialiasing = !FlxG.save.data.lowend;
		circleTwo.antialiasing = !FlxG.save.data.lowend;
