...
class ModTestState extends MusicBeatState
{
	...
	function createTestButtons()
	{
		...
		{
			var btn = createStylizedButton(FlxG.width - 210, buttonY, data.label, data.callback, data.key);
			buttonY += 40;
		}
	}
	...
	{
		var tooltip = new FlxText(10, FlxG.height - 40, FlxG.width - 20, "CTRL+R: Reload Mods | CTRL+T: Test All | ESC: Back to Menu | Mouse Wheel: Scroll");
