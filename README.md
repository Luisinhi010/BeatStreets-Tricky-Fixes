...
1. Install required Haxe libraries:
   The project uses a `haxelib.json` file to manage Haxe library dependencies. When you build the project for the first time, Lime should automatically detect and offer to install the required libraries.
